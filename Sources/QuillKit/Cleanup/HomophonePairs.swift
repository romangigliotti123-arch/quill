...
public enum HomophonePairs {
    ...
    public static let groups: [[String]] = [
        ...
        // Trimmed 21 Aug 2026 against 263 real dictations. The gate fired on 12%
        // of them, and the words doing the firing were past(7), through(7),
        // whether(6), course(4), week(3) — every one already correct. A group
        // that wakes the model constantly and has never needed to is pure cost,
        // so the high-frequency pairs are gone on the same reasoning that keeps
        // to/too/two and their/there out. What is left is what he could
        // plausibly get wrong in a brief or an invoice.
